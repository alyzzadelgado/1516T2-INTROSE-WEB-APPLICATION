	...
	<%
		...
		<div class="container">
				...
				<ul class="breadcrumb">
					<li><a href="homepage.html">Home</a></li>
					<li><a href="view_opportunities.jsp">Opportunities</a></li>
					<li class="active">Edit Requirements</li>
				</ul>
		...
		<div class="container">
				...
				<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-3"> <!--Column 2-->
								<h3>REQUIREMENTS</h3>
									<form name="reqForm" onsubmit="//return validateThirdForm();" role="form" method="POST" action="editRequirements">
										...
										<a href="view_opportunities.html" class="btn btn-info" style="margin-right:10px;background-color:#009688;border:none;color:white;" type="button">Add Opportunity</a>-->
                                                                                ...
                                                                                <input type="submit" name="save" value="Save" onclick="confirmation()" class="btn btn-info" style="margin-right:10px;background-color:#009688;border:none;color:white;"/>
