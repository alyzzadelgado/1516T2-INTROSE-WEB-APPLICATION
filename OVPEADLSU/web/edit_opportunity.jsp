		...
		<div class="container">
				...
				<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-3"> <!--Column 2-->
								...
								<br></br>
									 <form name="form" onsubmit="return validateFirstForm();" role="form" method="POST" action="editOpportunity">
										...
										<%
                                                                                ...
                                                                                if (session.getAttribute("oppTypeName")!=null)
                                                                                    ...
                                                                                    typeName = rsOpp.getString("type_name");
        ...
        <!-- Load jQuery and bootstrap datepicker scripts -->
					...
					<div class="col-lg-3 col-md-3 col-sm-3"><!--Column 4-->
								...
								<br></br>
										...
										<input type="submit" name="continue" value="Continue" id="continue" class="btn btn-info" style="margin-left:90px;margin-top:30px;background-color:#009688;border:none;color:white;"/>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#sDate').datepicker({                 
                    ...
                    var minDatePlus = new Date(new Date(minDate).setMonth(minDate.getMonth()+2));
            ...
            $(document).ready(function () {
                ...
                $('#eDate').datepicker({                  
                    format: "yyyy-mm-dd",
                      ...
                      var minDate = new Date(selected.date.valueOf());      
                          minDate =  $('#sDate').datepicker('getDate');
                          var minDatePlus = new Date(new Date(minDate).setMonth(minDate.getMonth()+2));
                    $('#eDate').datepicker('setStartDate',minDatePlus);
