...
public final class add_005fopportunity_005fpage1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            ");
            ...
            //Opportunity newOpp = (Opportunity) session.getAttribute("newOpp");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required name=\"name\" type=\"text\" class=\"form-control\" id=\"inputOppName\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required name=\"type\" type=\"text\" class=\"form-control\" id=\"inputCompany\">\r\n");
 ...
 while (rs.next()) {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<textarea required name=\"description\" class=\"form-control\" id=\"description\" rows=\"6\"></textarea>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input required name=\"startDate\" type=\"text\" class=\"form-control\" placeholder=\"Start date\" ></input>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input required name=\"endDate\" type=\"text\" class=\"form-control\" placeholder=\"End date\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon add-on\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"glyphicon glyphicon-calendar\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required name=\"contactPerson\" type=\"text\" class=\"form-control\" id=\"inputContactPerson\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required maxlength=\"12\" name=\"contactPhone\" type=\"text\" class=\"form-control\" id=\"phoneNumber\" placeholder=\"Phone\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<br></br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required maxlength=\"12\" name=\"contactLandline\" type=\"text\" class=\"form-control\" id=\"landline\" placeholder=\"Landline\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input required name=\"email\" type=\"text\" class=\"form-control\" id=\"emailAdd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("                                                                                       <!--<input required name=\"colleges\" value=\"</%=Opportunity.newOpp.getCollege()%>\" hidden>-->\r\n");
      ...
      out.write("                                                                                    </div>\r\n");
      out.write("                                                                                </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"Continue\" class=\"btn btn-info\" style=\"margin-left:90px;margin-top:30px;background-color:#009688;border:none;color:white;\"/>\r\n");
