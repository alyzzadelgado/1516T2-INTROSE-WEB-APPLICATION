 ...
 * @author pauldelgado
 */
public class editRequirements extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("save")!=null) {
            ...
            currId = Integer.parseInt(String.valueOf(session.getAttribute("currOppId")));

            newOpp.setId(currId);
            newOpp.setName(String.valueOf(session.getAttribute("oppName")));
            newOpp.setType(String.valueOf(session.getAttribute("oppType")));
            newOpp.setTypeName(String.valueOf(session.getAttribute("typeName")));
            ...
            edited = oppDB.editOpp(newOpp);
            OppItemDAO itemsDB = new OppItemDAO();
            itemsDB.deleteItem(currId);

            if (edited==true) {
                nextStep="/view_opportunities.jsp";
                session.setAttribute("saveOpp", "success");
            }
                ...
                if (!(session.getAttribute("oppColleges").equals(""))) {
                    ...
                    colleges.setOppId(newOpp.getId());
            ...
            nextStep="/edit_qualifications.jsp";
